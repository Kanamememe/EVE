...
(function (window, document) {
  ...
  function run() {
    ...
    const results = [
      ...
      test('diary-loaded', Boolean(window.EVEDiary), JSON.stringify(window.EVEDiary?.diagnostics?.() || {}), 'warning'),
      test('diary-home-app', Boolean(window.EVEDiaryApp && document.getElementById('eve-diary-home-app') && document.getElementById('eve-diary-screen')), window.EVEDiaryApp?.version || '', 'warning'),
      test('native-notifications', Boolean(window.EVENativeNotifications), JSON.stringify(window.EVENativeNotifications?.getDiagnostics?.() || {}), 'warning'),
      test('native-icon-helper', Boolean(window.EVENativeAppIcon), window.EVENativeAppIcon?.version || '', 'warning'),
